...
<table>
    ...
    <center>
        ...
        <form action="?statues=delete" method="POST" enctype="multipart/form-data">
...
?>
		...
		<br>
            ...
            <div class="form-group">
                <div class="form-control" name="caption" ><? echo nl2br(str_replace($SEARCH,$GANTI,$gt['caption'])); ?></div>
            </div>

<input type="hidden" name="username" value="<? echo $username; ?>" />
<input type="hidden" name="i" value="<? echo $id; ?>" />

            <input type="submit" class="btn btn-danger btn-block" name="del" value="Hapus Postingan" />

</form>
<br>
<a class="ttp-href" href="./"><button class="btn btn-success btn-block" >Batalkan Penghapusan</button></a>
</div>
